...
plot(density(y2orig), lwd = 2, col = "dark green", main = "MNAR", xlab = "Value of Y2", xlim = c(-5,15),
     ylim = c(0,0.3))
lines(density(y2[!is.na(y2)]), lwd = 2, col = "blue")
legend(8, 0.3, legend = c("Complete Y2", "Observed Y2"),
       col = c("dark green", "blue"), lty = c(1,1), lwd = c(2,2), bty = "n")
```
...
plot(density(y2orig), lwd = 2, col = "dark green", main = "MNAR with Imputation",
     xlab = "Value of Y2", xlim = c(-5,15), ylim = c(0,0.3))
lines(density(y2_completed), lwd = 2, col = "blue")
legend(8, 0.3, legend = c("Complete Y2", "Y2 w/ Imputation"),
       col = c("dark green", "blue"), lty = c(1,1), lwd = c(2,2), bty = "n")
```
...
plot(density(y2orig), lwd = 2, col = "dark green" ,xlim = c(-5,15), ylim = c(0,0.3),
     main = "Marginal distributions for complete and MNAR", xlab = "Value of Y2")
lines(density(y2[!is.na(y2)]), lwd = 2, col = "blue")
legend(8, 0.3, legend = c("Complete Y2", "Observed"),
       col = c("dark green", "blue"), lty = c(1,1), lwd = c(2,2), bty = "n")
```
...
plot(density(y2orig), lwd = 2, col = "dark green", xlim = c(-5,15), ylim = c(0,0.3),
     main = "Marginal distributions for complete and observed w/ imputations", xlab = "Value of Y2")
lines(density(y2_completed), lwd = 2, col = "blue")
legend(8, 0.3, legend = c("Complete Y2", "Y2 w/ Imputation"),
       col = c("dark green", "blue"), lty = c(1,1), lwd = c(2,2), bty = "n")
